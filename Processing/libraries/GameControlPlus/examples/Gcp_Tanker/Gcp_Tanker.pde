/**
 ...
 with 2 sliders and 5 buttons will work. If your device doesn't
 appear to control the tank make sure that the details in the 
 config file are unique for your device,
...
public void setup() {
  size(640, 480);
  surface.setTitle("Tank timer game for joystick");
