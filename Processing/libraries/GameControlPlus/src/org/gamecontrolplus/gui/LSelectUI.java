...
// * 
// * A line for each device found e.g. joystick, gamepad, keyboard etc.
// * 
// * @author Peter Lager
// *
// */
...
//
//		String title = "Select device for " + LSelectUI.config.getUsage();
...
//		ControlIO.getInstance(null).setConfiguredDevice(null);
//		window.forceClose();
//	}
//
